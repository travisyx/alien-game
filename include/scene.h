...
/**
* Makes force struct, including a force_creator_t and a void * of aux data.
*/
...
/**
* Initializes force_t struct with func and aux.
*/
force_t *force_init(force_creator_t func, void *aux, list_t *bodies, free_func_t aux_free);

/**
* Frees a force_t struct.
*/
...
// returns bool of whether body rem is associated with force
bool force_is_removed(force_t *force, body_t *rem);

// updates scene by removing any flagged bodies and their ass. forces
