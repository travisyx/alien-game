...
/**
 * Frees a vector pointer. Is of type free_func_t and can be passed in as arg.
 * Casts thing being freed to vector_t * type as well in case type issue from void
 *
 * @param x, vector_t pointer
 */
...
// returns distance between two vectors. will always be positive
